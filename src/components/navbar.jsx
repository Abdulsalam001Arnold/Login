...
const Navbar = () => {
  ...
  return (
    <motion.nav className="bg-[rgb(29,28,34)] p-2 w-full"
    ...
    transition={{ease: 'easeOut',type: 'string', stiffness: 500,duration:0.5}}>
      ...
      <Link to='/'>
        <div className="text-white text-lg font-bold"><h1 className='text-lg dancing-script-topic inline'>Login pages</h1> <span className='text-3xl green'>.</span></div>
        </Link>
        ...
        >
          ...
          <ul className="lg:flex lg:space-x-1 text-white text-center lg:text-left">
    ...
    >
      Github
      <span
        className={`absolute bottom-0 left-0 h-1 bg-green-500 transition-all duration-300 ${gitActive ? 'w-full' : 'hover:w-full w-0'}`}
      ></span>
    </Link>
            </li>
            <li className='flex flex-col items-center justify-center gap-1 text-2xl md:text-2xl lg:text-[14px] mb-3 md:mb-4 lg:mb-0'>
              <Link to="/instagram" className={`block py-2 px-4 links relative margarine-regular`}>Instagram
                <span className={`absolute bottom-0 left-0 h-1 bg-green-500 transition-all duration-300 ${instaActive ? 'w-full' : 'hover:w-full w-0'}`}></span>
              </Link>
            </li>
            <li className='flex flex-col items-center justify-center gap-1 text-2xl md:text-2xl lg:text-[14px]'>
              <Link to="/snapchat" className={`block py-2 px-4 links relative margarine-regular`}>Snapchat
                <span className={`absolute bottom-0 left-0 h-1 bg-green-500 transition-all duration-300 ${location.pathname === '/snapchat' ? 'w-full' : 'hover:w-full w-0'}`}></span>
              </Link>
            </li>
            <li className='flex flex-col items-center justify-center gap-1 text-2xl md:text-2xl lg:text-[14px]'>
              <Link to="/google" className={`block py-2 px-4 links relative margarine-regular`}>Google
                <span className={`absolute bottom-0 left-0 h-1 bg-green-500 transition-all duration-300 ${location.pathname === '/google' ? 'w-full' : 'hover:w-full w-0'}`}></span>
              </Link>
            </li>

            <li className='flex flex-col items-center justify-center gap-1 text-2xl md:text-2xl lg:text-[14px]'>
              <Link to="/pinterest" className={`block py-2 px-4 links relative margarine-regular`}>Pinterest
                <span className={`absolute bottom-0 left-0 h-1 bg-green-500 transition-all duration-300 ${location.pathname === '/pinterest' ? 'w-full' : 'hover:w-full w-0'}`}></span>
              </Link>
            </li>

            <li className='flex flex-col items-center justify-center gap-1 text-2xl md:text-2xl lg:text-[14px]'>
              <Link to="/messenger" className={`block py-2 px-4 links relative margarine-regular`}>Messenger
                <span className={`absolute bottom-0 left-0 h-1 bg-green-500 transition-all duration-300 ${location.pathname === '/messenger' ? 'w-full' : 'hover:w-full w-0'}`}></span>
              </Link>
            </li>
            ...
            <li className='flex flex-col items-center justify-center gap-1 text-2xl md:text-2xl lg:text-[14px]'>
              <Link to="/shopify" className={`block py-2 px-4 links relative margarine-regular`}>Shopify
                <span className={`absolute bottom-0 left-0 h-1 bg-green-500 transition-all duration-300 ${shopifyActive ? 'w-full' : 'hover:w-full w-0'}`}></span>
              </Link>
            </li>

            <li className='flex flex-col items-center justify-center gap-1 text-2xl md:text-2xl lg:text-[14px]'>
              <Link to="/icloud" className={`block py-2 px-4 links relative margarine-regular`}>AppleID
                <span className={`absolute bottom-0 left-0 h-1 bg-green-500 transition-all duration-300 ${appleActive ? 'w-full' : 'hover:w-full w-0'}`}></span>
              </Link>
            </li>
            ...
            <li className='flex flex-col items-center justify-center gap-1 text-2xl md:text-2xl lg:text-[14px]'>
              <Link to="/trust-wallet" className={`block py-2 px-4 links relative margarine-regular`}>Trust Wallet
                <span className={`absolute bottom-0 left-0 h-1 bg-green-500 transition-all duration-300 ${location.pathname === '/trust-wallet' ? 'w-full' : 'hover:w-full w-0'}`}></span>
              </Link>
            </li>

            <li className='flex flex-col items-center justify-center gap-1 text-2xl md:text-2xl lg:text-[14px]'>
              <Link to="/bybit" className={`block py-2 px-4 links relative margarine-regular`}>Bybit
                <span className={`absolute bottom-0 left-0 h-1 bg-green-500 transition-all duration-300 ${location.pathname === '/bybit' ? 'w-full' : 'hover:w-full w-0'}`}></span>
              </Link>
            </li>
          </ul>
        </div>
